...
parser = argparse.ArgumentParser(description="Download seed sentences and instructions")
parser.add_argument("output_dir", type=str, help="Directory to save the datasets")
args = parser.parse_args()

sentences_path = os.path.join(args.output_dir, "seed_sentences")
instructions_path = os.path.join(args.output_dir, "seed_instructions")
...
dataset.save_to_disk(sentences_path)
...
dataset.save_to_disk(instructions_path)
